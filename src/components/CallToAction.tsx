  ...
  return (
    <section className="relative px-6 py-20">
      <div className="max-w-5xl mx-auto">
        {/* Main CTA Card */}
        <div className="relative overflow-hidden p-8 md:p-12 bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-500 rounded-3xl shadow-2xl mb-12">
      ...
      {/* Footer */}
      <div className="max-w-7xl mx-auto mt-20 pt-12 border-t border-emerald-200">
        <div className="flex flex-col items-center gap-4 text-center">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-2">青龙安答</h3>
            <p className="text-slate-600">智能店小二系统</p>
          </div>
